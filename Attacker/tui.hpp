...
namespace ftxui {
	...
	private:
		...
		bool is_sending_mouse = false, is_sending_keyboard = false, is_getting_video = false;
		Component mouse_checkbox, keyboard_checkbox, video_checkbox;
